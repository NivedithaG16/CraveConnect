...
const Header = () => {
  return (
    <div className="header">
      <div className="logo">
        <img src="https://cdn.dribbble.com/userupload/22636569/file/original-6e345e102a5f8c975b24b3268bf5c22e.jpg?resize=752x&vertical=center" />
      </div>
...
const resList = [
  ...
  },
  {
    ...
    data: {
      ...
      cuisines: ["Indian", "Chinese", "Tandoor", "Fast Food", "Thalis"],
      tags: [],
      costForTwo: 20000,
...
//       <div className="logo">
//         <img
//           src="https://cdn.dribbble.com/userupload/22636569/file/original-6e345e102a5f8c975b24b3268bf5c22e.jpg?resize=752x&vertical=center"
//           alt=""
//         />
//       </div>
//       <div className="nav-items">
...
// const RestaurantCard = ({ resData }) => {
//   const { name, cloudinaryImageId, avgRating, cuisines, deliveryTime } =
//     resData?.data;
//   return (
//     <div className="list">
//       <h3>{name}</h3>
...
//         {resList.map((ele) => (
//           <RestaurantCard key={ele.data.id} resData={ele} />
//         ))}
//       </div>
//     </div>
//   );
